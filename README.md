...
| **OASIS3** | (docs only) | NIfTI | Docs (8 docs) |
| **KBASE** | (docs only) | NIfTI | Docs (12 docs) |
| **NACC** | `src/nacc/` | NIfTI | Docs (10 docs); pipeline planned |
...
| [`docs/oasis3/session_label_reference.md`](docs/oasis3/session_label_reference.md) | OASIS3 session label grammar (`OAS3xxxx_<token>_d####`), 음수 days quirk |
...
| 문서 | 내용 |
|------|------|
| [`docs/nacc/README.md`](docs/nacc/README.md) | NACC 시작점 (NFS 경로, 한 눈에 보기, 다른 코호트와 차이) |
| [`docs/nacc/data_catalog.md`](docs/nacc/data_catalog.md) | DEMO/NII_NEW/DCM/ZIP 마스터 인벤토리 |
| [`docs/nacc/protocol.md`](docs/nacc/protocol.md) | 29+ ADRCs, UDS v1→v4, 분기 freeze, naccdata.org DUA |
| [`docs/nacc/data_tier_reference.md`](docs/nacc/data_tier_reference.md) | Commercial vs Investigator (Non_Commercial) 컨센트 분리 |
| [`docs/nacc/merged_csv.md`](docs/nacc/merged_csv.md) | NeuroXT-built `merged.csv` 390-col 사전 |
| [`docs/nacc/uds_forms.md`](docs/nacc/uds_forms.md) | NACC overlay (NACCID/NACCADC/PACKET/FORMVER, v3↔v4 deltas) |
| [`docs/nacc/session_label_reference.md`](docs/nacc/session_label_reference.md) | (NACCID, NACCVNUM, PACKET) 4-tuple, longitudinal 패턴 |
| [`docs/nacc/optional_modules.md`](docs/nacc/optional_modules.md) | FTLD3 / LBD3.1 / CSF / SCAN MRI/PET / ADSP-PHC 122024 |
| [`docs/nacc/imaging_inventory.md`](docs/nacc/imaging_inventory.md) | NII_NEW/ 트리, 14+ 모달리티, 6,548 imaged subjects |
| [`docs/nacc/join_relationships.md`](docs/nacc/join_relationships.md) | (NACCID, NACCVNUM, PACKET) 조인 키, 카디널리티 |

### KBASE
| 문서 | 내용 |
|------|------|
| [`docs/kbase/README.md`](docs/kbase/README.md) | KBASE 시작점 (visit schedule, ID 체계, known quirks) |
| [`docs/kbase/data_catalog.md`](docs/kbase/data_catalog.md) | 7 xlsx + csv 3-tier 인벤토리 |
| [`docs/kbase/protocol.md`](docs/kbase/protocol.md) | 코호트 설계, 9 모달리티, ADNI/OASIS3/A4 비교 |
| [`docs/kbase/master_columns.md`](docs/kbase/master_columns.md) | `masterfile.{xlsx,csv}` 150-col 사전 |
| [`docs/kbase/imaging_inventory.md`](docs/kbase/imaging_inventory.md) | V0/V2/V4 시트 + 모달리티 가용성 인코딩 |
| [`docs/kbase/diagnosis_demographics.md`](docs/kbase/diagnosis_demographics.md) | `2_Diag_Demo.xlsx` simplified + Sheet1 codebook + GROUP↔y2_diag 불일치 |
| [`docs/kbase/codebook_dx.md`](docs/kbase/codebook_dx.md) | y2_diag / y2_desc 진단명 매핑 |
| [`docs/kbase/apoe.md`](docs/kbase/apoe.md) | KBASE APOE + cross-cohort 비교 |
| [`docs/kbase/neuropsych_battery.md`](docs/kbase/neuropsych_battery.md) | 4_NP.xlsx 72-col 신경심리 |
| [`docs/kbase/vascular_risk_factors.md`](docs/kbase/vascular_risk_factors.md) | 5_VRF.xlsx + JSON-string quirk |
| [`docs/kbase/pib_positivity.md`](docs/kbase/pib_positivity.md) | PiB SUVR 1.40 cutoff + casing quirk |
| [`docs/kbase/join_relationships.md`](docs/kbase/join_relationships.md) | (ID, K_visit) 단일 join 키 |

### NACC ↔ OASIS3 공통 (`docs/_shared/`)
| 문서 | 내용 |
|------|------|
| [`docs/_shared/nacc_uds_forms.md`](docs/_shared/nacc_uds_forms.md) | NACC UDS 17 폼 (A1–D2) 컬럼 정의 — NACC와 OASIS3 양쪽이 참조 |
| [`docs/_shared/nacc_session_labels.md`](docs/_shared/nacc_session_labels.md) | UDS PACKET 그래머, missing-code 처리, 영상-임상 시간 매칭 |
