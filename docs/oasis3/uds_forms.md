...
> - `OASIS_session_label` — 세션 라벨 (form-specific 토큰. [`session_label_reference.md`](session_label_reference.md))
...
| [`session_label_reference.md`](session_label_reference.md) | 세션 라벨 grammar (`UDSx{N}`, `USDa3`, `psychometrics` 토큰) |
| [`protocol.md`](protocol.md) | UDS v2/v3 전환, 코호트 구조 |
| [`join_relationships.md`](join_relationships.md) | Form-form join, A4 D/G 페어링 |
