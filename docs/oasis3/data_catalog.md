...
>
> **세션 라벨 grammar**: `OAS3{0001-1379}_{FORM}_d{0000-9999}` — 예: `OAS30001_UDSb4_d0339` = subject `OAS30001`, NACC UDS b4(CDR) form, day 339. 자세한 규칙은 [`session_label_reference.md`](session_label_reference.md).
>
...
> 1,378 OASIS3 참가자(LaMontagne 2019 발표 기준 원본 N) vs demographics 1,379행 — 차이는 **2025-12 Tau (AV1451) sub-project 본 프로젝트 통합으로 +1명** 추가된 결과 (현재 N=1,379가 정확). 자세한 내용은 [`protocol.md`](protocol.md) §1 + §7. 분석 시 `OASISID.nunique()`로 확인.
