...
PET NIfTI 원본은 `oasis_file_list.csv`의 SEQ ∈ {AV45, PIB, AV1451, FDG} 행에서 PATH 컬럼으로 조회 가능. 자세한 내용은 [`OASIS3_file_index.md`](OASIS3_file_index.md).
...
| [`OASIS3_protocol.md`](OASIS3_protocol.md) | 연구 배경, 트레이서 사용 방침 |
| [`OASIS3_file_index.md`](OASIS3_file_index.md) | NIfTI 경로, BIDS 명명 규칙 |
| [`OASIS3_join_relationships.md`](OASIS3_join_relationships.md) | PET-clinical 조인 패턴 |
